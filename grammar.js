...
module.exports = grammar({
  ...
  rules: {
    ...
    section_statement: $ => seq($.section, field('section_name', $.identifier)),
    ...
    namespace_script: $ => seq(
      $.namespace_statement,
      optional($._namespace_body),
      terminator, $.endnamespace_statement,
    ),
    _namespace_body: $ => repeat1(seq(terminator, choice(
      alias($._expression, $.statement),
      $._trad,
      $.namespace_script,
      $.namespace_section,
    ...
    _class_body: $ => repeat1(seq(terminator, choice(
      alias($._expression, $.statement),
      $._trad,
      $.namespace_script,
      $.class_definition,
