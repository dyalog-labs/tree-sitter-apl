...
module.exports = grammar({
  ...
  conflicts: $ => [
    ...
    [$.dop2_names, $.dop1_names, $.dfn_names, $.names],
    [$.dop2_names, $.dop1_names, $.dfn_names],
    [$.dop2_names, $.dop1_names],
    [$.dop1_names, $.dfn_names, $.names],
    [$.dop1_names, $.dfn_names],
    [$.dfn_names, $.names],
...
function def_rules() {
  const rules = {
    ...
    // a names includes members separated by terminators, or could be empty
    names($$, d) {
